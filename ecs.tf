...
resource "aws_ecs_task_definition" "own_task_definition" {
  ...
  #   image_url        = "255945442255.dkr.ecr.us-east-1.amazonaws.com/sufiyan-test-ecr-repo:latest"
  #   container_name   = "sufiyan-test-ecs"
  #   port_name        = "sufiyan-test-ecs-8080-tcp"
  #   log_group_region = "us-east-1"
  #   log_group_name   = "/ecs/sufiyantesttaskdef"
